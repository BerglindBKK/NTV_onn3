...
-- rating: 7.2
-- watched: FALSE
insert into MOVIES (title, release_year, duration_minutes, box_office_millions, rating, watched)
VALUES('The Matrix Reloaded', 2003, 138, 742.1, 7.2, FALSE)
...
VALUES ('Denis Villeneuve', 1967, 'Canadian');
...
VALUES ('Timothée Chalamet', 1995, 'American');
...
INSERT INTO movies (title, release_year, duration_minutes, box_office_millions, rating, watched)
VALUES
  ('Blade Runner 2049', 2017, 164, 267.7, 8.0, FALSE),
  ('Arrival', 2016, 116, 203.4, 7.9, FALSE),
  ('Sicario', 2015, 121, 84.9, 7.6, FALSE);
...
INSERT INTO movies (title, release_year, watched)
VALUES ('Test Movie', 2024, FALSE);
...
VALUES (1, 'Your Name', 5, 'Amazing movie! A perfect conclusion.', CURRENT_DATE);
...
SET duration_minutes = 120,
    rating = 6.5,
    description = 'A test movie for practice'
