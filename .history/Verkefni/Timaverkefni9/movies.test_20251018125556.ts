...
const fakeMovies: MovieResponse[] = [
  { id: '9a809de6-2739-4fee-a627-d9d9db1fbff5', title: 'Avengers: End Game', done: false },
  {
...
describe('movies.ts - Data Logic Unit Tests', () => {
  describe('loadMoviesPaginatedAsync', () => {
    it.todo('should load and parse movies correctly without pagination', async () => {});

    it.todo('should return a correctly paginated slice of movies', async () => {});
  ...
  describe('saveMoviesAsync', () => {
    it.todo('should call writeFile with correctly stringified data', async () => {});

    it.todo('should throw an error if writeFile fails', async () => {});
  });

  describe('addMoviesAsync', () => {
    it.todo('should add a new movie to the existing list and save it', async () => {});
  });

  describe('markMoviesDoneAsync', () => {
    it.todo('should find a movie by ID, update its "done" status, and save', async () => {});
